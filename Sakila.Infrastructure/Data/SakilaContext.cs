    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Actor>(entity =>
        {
            entity.HasKey(e => e.ActorId)
                .HasName("PK__actor__8B2447B5B26C57E6")
                .IsClustered(false);
        ...
        modelBuilder.Entity<Address>(entity =>
        {
            entity.HasKey(e => e.AddressId)
                .HasName("PK__address__CAA247C91A43C8A7")
                .IsClustered(false);
        ...
        modelBuilder.Entity<Category>(entity =>
        {
            entity.HasKey(e => e.CategoryId)
                .HasName("PK__category__D54EE9B5C1CFF2EC")
                .IsClustered(false);
        ...
        modelBuilder.Entity<City>(entity =>
        {
            entity.HasKey(e => e.CityId)
                .HasName("PK__city__031491A9034D09BE")
                .IsClustered(false);
        ...
        modelBuilder.Entity<Country>(entity =>
        {
            entity.HasKey(e => e.CountryId)
                .HasName("PK__country__7E8CD0540BEDB4D2")
                .IsClustered(false);
        ...
        modelBuilder.Entity<Customer>(entity =>
        {
            entity.HasKey(e => e.CustomerId)
                .HasName("PK__customer__CD65CB841B6B7A48")
                .IsClustered(false);
        ...
        modelBuilder.Entity<Film>(entity =>
        {
            entity.HasKey(e => e.FilmId)
                .HasName("PK__film__349764A8D58870E6")
                .IsClustered(false);
        ...
        modelBuilder.Entity<FilmActor>(entity =>
        {
            entity.HasKey(e => new { e.ActorId, e.FilmId })
                .HasName("PK__film_act__086D31FFC409F0BE")
                .IsClustered(false);
        ...
        modelBuilder.Entity<FilmCategory>(entity =>
        {
            entity.HasKey(e => new { e.FilmId, e.CategoryId })
                .HasName("PK__film_cat__69C38A3304BDA60B")
                .IsClustered(false);
        ...
        {
            entity.HasKey(e => e.FilmId)
                .HasName("PK__film_tex__349764A827088FEB")
                .IsClustered(false);
            ...
            entity.HasOne(d => d.Film).WithOne(p => p.FilmText)
                .HasForeignKey<FilmText>(d => d.FilmId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<Inventory>(entity =>
        {
            entity.HasKey(e => e.InventoryId)
                .HasName("PK__inventor__B59ACC480B60E5FE")
                .IsClustered(false);
        ...
        modelBuilder.Entity<Language>(entity =>
        {
            entity.HasKey(e => e.LanguageId)
                .HasName("PK__language__804CF6B21B628D70")
                .IsClustered(false);
        ...
        modelBuilder.Entity<Payment>(entity =>
        {
            entity.HasKey(e => e.PaymentId)
                .HasName("PK__payment__ED1FC9EBF97065F0")
                .IsClustered(false);
        ...
        modelBuilder.Entity<Rental>(entity =>
        {
            entity.HasKey(e => e.RentalId)
                .HasName("PK__rental__67DB611A495DC61E")
                .IsClustered(false);
        ...
        modelBuilder.Entity<Staff>(entity =>
        {
            entity.HasKey(e => e.StaffId)
                .HasName("PK__staff__1963DD9D18EBCF93")
                .IsClustered(false);
        ...
        modelBuilder.Entity<Store>(entity =>
        {
            entity.HasKey(e => e.StoreId)
                .HasName("PK__store__A2F2A30D7AF40954")
                .IsClustered(false);
